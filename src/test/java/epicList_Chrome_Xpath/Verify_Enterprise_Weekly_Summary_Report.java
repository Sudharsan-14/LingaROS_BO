...
//	ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
		...
		{ 
			...
			driver.findElement(By.xpath(excel.getData(3, 1513, 1))).click();
			//Enter the required filter
			driver.findElement(By.xpath(excel.getData(3, 1514, 1))).sendKeys(Utility.getReportProperty("Store"));
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(3, 1514, 1))).sendKeys(Keys.ENTER);

			Thread.sleep(3000);
			//Click the Time Period option
			driver.findElement(By.xpath(excel.getData(3, 1515, 1))).click();
			//Enter the required Time Period
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys("This week");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys(Keys.ENTER);
		...
		public void Weekly_Summary_Enterprise_Report_Method_For_Last_Week(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 1515, 1))).click();
			//Enter the required Time Period
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys("Last week");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys(Keys.ENTER);
			
			Thread.sleep(2000);
			//Click the Run Button
			driver.findElement(By.xpath(excel.getData(3, 1533, 1))).click();
		...
		{   
			...
			driver.findElement(By.xpath(excel.getData(3, 1515, 1))).click();
			//Enter the required Time Period
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys("Last 7 days");
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 1516, 1))).sendKeys(Keys.ENTER);
