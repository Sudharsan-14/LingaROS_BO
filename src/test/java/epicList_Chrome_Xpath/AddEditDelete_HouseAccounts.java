...
public class AddEditDelete_HouseAccounts {
	...
	ExtentTest test = rep.startTest("AddEditDelete_HouseAccounts");
		...
		public void HouseAccount_Method_OpenPage(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 649, 1))).getText().equalsIgnoreCase("House Account"))
			{
		...
		public void HouseAccount_Method_CreateNewHouseAccounts(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath(excel.getData(3, 650, 1))).getText().equalsIgnoreCase("New House Account"))
			{
		...
		public void HouseAccount_Method_addHouseAccountsfor_Daily(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 662, 1))).click();
			//Enter the required Customer name in the Corresponding field
			driver.findElement(By.xpath(excel.getData(3, 663, 1))).sendKeys(Utility.getProperty("HA_Customer_Name"));
			//Press the Enter Key
			driver.findElement(By.xpath(excel.getData(3, 663, 1))).sendKeys(Keys.ENTER);
			Thread.sleep(2000);
			
			//Clear the Account number field
			driver.findElement(By.name(excel.getData(3, 660, 3))).clear();
			//Enter the required name
			driver.findElement(By.name(excel.getData(3, 660, 3))).sendKeys(Utility.getProperty("HA_Account_Number"));
			//Click the Allow Credits Check box
			driver.findElement(By.xpath(excel.getData(3, 655, 1))).click();
			//Click the Enable Limit Check box
			driver.findElement(By.xpath(excel.getData(3, 656, 1))).click();
			//Click the Enable Max Limit button
			driver.findElement(By.xpath(excel.getData(3, 657, 1))).click();
			//Select the Limit Period as Daily
			Select limitPeriod = new Select(driver.findElement(By.xpath(excel.getData(3, 661, 1))));
			limitPeriod.selectByVisibleText("Daily");
			//Enter the minimum Limit
			driver.findElement(By.name(excel.getData(3, 653, 3))).clear();
			//Enter the minimum Limit
			driver.findElement(By.name(excel.getData(3, 653, 3))).sendKeys("1500");
			//Enter the Maximum Limit
			driver.findElement(By.name(excel.getData(3, 654, 3))).clear();
			//Enter the Maximum Limit
			driver.findElement(By.name(excel.getData(3, 654, 3))).sendKeys("2000");
			//Enter the Balance amount
			driver.findElement(By.name(excel.getData(3, 153, 3))).clear();
			//Enter the Balance amount
			driver.findElement(By.name(excel.getData(3, 153, 3))).sendKeys("2500");
			Thread.sleep(2000);
			...
			if(driver.findElement(By.xpath(excel.getData(3, 576, 1))).getText().equalsIgnoreCase("House Account saved successfully"))
			{										
				test.log(LogStatus.PASS,"House Account Daily Saved  Sucessfully");
			}
			else
			{
				test.log(LogStatus.FAIL,"House Account Daily Save Failed");wb.close();
			}
		...
		public void HouseAccount_Method_EditHouseAccountsfor_Weekly(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys(Utility.getProperty("HA_Customer_Name"));
			//Click the Edit icon
			...
			Thread.sleep(1000);
				...
				Select limitPeriod = new Select(driver.findElement(By.xpath(excel.getData(3, 658, 1))));
				limitPeriod.selectByVisibleText("Weekly");
				Thread.sleep(2000);
				//Select the Start Day option
				Select startDay = new Select(driver.findElement(By.xpath(excel.getData(3, 659, 1))));
				startDay.selectByVisibleText("WEDNESDAY");
				Thread.sleep(2000);
				//Clear the limit field
				driver.findElement(By.name(excel.getData(3, 653, 3))).clear();
				//Enter the minimum Limit
				driver.findElement(By.name(excel.getData(3, 653, 3))).sendKeys("1600");
				//Clear the Maximum Limit
				driver.findElement(By.name(excel.getData(3, 654, 3))).clear();
				//Enter the Maximum Limit
				driver.findElement(By.name(excel.getData(3, 654, 3))).sendKeys("2100");
				//Click the Save button
				driver.findElement(By.xpath(excel.getData(3, 572, 1))).click();
				Thread.sleep(2000);
		...
		public void HouseAccount_Method_EditHouseAccountsfor_Monthly(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.name(excel.getData(3, 653, 3))).clear();
			//Enter the minimum Limit
			driver.findElement(By.name(excel.getData(3, 653, 3))).sendKeys("1700");
			//Clear the Maximum Limit
			driver.findElement(By.name(excel.getData(3, 654, 3))).clear();
			//Enter the Maximum Limit
			driver.findElement(By.name(excel.getData(3, 654, 3))).sendKeys("2200");
			//Click the Save button
			driver.findElement(By.xpath(excel.getData(3, 572, 1))).click();
			Thread.sleep(5000);
		...
		{	
			...
			if(driver.findElement(By.xpath(excel.getData(3, 576, 1))).getText().equalsIgnoreCase("House account inactivated successfully"))
			{									
		...
		public void HouseAccount_Method_DeActivestatus(WebDriver driver) throws Exception
		{
		    ...
		    driver.findElement(By.xpath(excel.getData(3, 651, 1))).click();
			//Clear the search field
		    Thread.sleep(5000);
		    driver.findElement(By.xpath(excel.getData(3, 40, 1))).clear();
				//Enter the required keyword
			...
			if(driver.findElement(By.xpath(excel.getData(3, 576, 1))).getText().equalsIgnoreCase("House account activated successfully"))
			{
