...
/*		//Click the Products/Items option
	...
	public void Item_Based_Discount_method_addDiscount_ItemBased_ApplicableTimePeriodAsDaysOfWeek(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).clear();
		//Enter the Coupon Code
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).sendKeys(Utility.getProperty("ItemBased_Discount_Code"));
		
		//Click the Level Field
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[1]/div/div/a")).click();
		//Enter the required Level
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[1]/div/div/div/div/input")).sendKeys("Menu item");
		//Press the Enter Key
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[1]/div/div/div/div/input")).sendKeys(Keys.ENTER);
		
		Thread.sleep(3000);
		//Click the Menu Item Field
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[2]/div/div/ul")).click();
		//Enter the required Menu Item
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[2]/div/div/ul/li/input")).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter keys
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[2]/div/div/ul/li/input")).sendKeys(Keys.ENTER);	
		Thread.sleep(2000);
		
		//Check whether the All Serving Size in Menu Item
		if(driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[3]/div/input")).isSelected())
		{}
		else
		{
			driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[3]/div/input")).click();
		}
	...
	public void Item_Based_Discount_method_editDiscount_ItemBased(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//form[@name='discountForm']/div[1]/div[5]/div[1]/div/div/div/div/input")).sendKeys("Category");
		...
		List<WebElement> ssize = driver.findElements(By.xpath("//select[@name='servingSizes']/../div/ul/li/a"));
		for(int i = 1; i < ssize.size();i++)
		{
			//Click the Close button of Serving Sizes
			driver.findElement(By.xpath("//select[@name='servingSizes']/../div/ul/li/a")).click();
		}
...
//		Thread.sleep(7000);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsDaysOfMonth(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).clear();
		//Enter the Coupon Code
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).sendKeys(Utility.getProperty("ItemBased_Discount_Code")+"a");
...
/*		//Click the Level Field
	...
	public void Item_Based_Discount_method_editDiscount_ItemBased_ApplicableTimePeriodAsSpecificDate(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).clear();
		//Enter the Coupon Code
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).sendKeys(Utility.getProperty("ItemBased_Discount_Code")+"b");
...
/*		//Click the Level Field
	...
	public void Item_Based_Discount_method_addSameName(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).clear();
		//Enter the Coupon Code
		driver.findElement(By.xpath("//label[.='Coupon code']/../div/input")).sendKeys(Utility.getProperty("ItemBased_Discount_Code")+"c");
		...
		Thread.sleep(2000);
		//Click the Discount Field DropDown Option
		driver.findElement(By.xpath("//input[@name='offer']")).clear();
		//Click the Free Item Field
		driver.findElement(By.xpath("//input[@name='offer']")).sendKeys("1500");
		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
