...
public class Verify_Discount_Report {
	...
	*/								
			...
			public void Discount_Report_Search_Field_Discount_Report(WebDriver driver) throws Exception
			{
				...
				//Get the Date
				String date = driver.findElement(By.xpath(excel.getData(3, 891, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 894, 1))).getText().equals(date))
						{}
						else
						{
				...
				//Get the Check
				String check = driver.findElement(By.xpath(excel.getData(3, 895, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 894, 1))).getText().equals(check))
						{}
						else
						{
				...
				//Get the Employee
				String emp = driver.findElement(By.xpath(excel.getData(3, 897, 1))).getText();
				...
				{				
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 899, 1))).getText().equals(emp))
						{
							Thread.sleep(1000);
							...
							String checkNum = driver.findElement(By.xpath(excel.getData(3, 902, 1))).getText();
							
							//Get the Transaction Date
							String transactionDate = driver.findElement(By.xpath(excel.getData(3, 903, 1))).getText();
		
							//Get the Net sales
							String netSales = driver.findElement(By.xpath(excel.getData(3, 904, 1))).getText();
		
							//Get the Total Tax amount
							String totalTaxAmount = driver.findElement(By.xpath(excel.getData(3, 905, 1))).getText();
		
							//Get the Inclusive Tax Amount
							String incTaxAmount = driver.findElement(By.xpath(excel.getData(3, 906, 1))).getText();
		
							//Get the CC Service Charge
							String ccServiceCharge = driver.findElement(By.xpath(excel.getData(3, 907, 1))).getText();
		
							//Get the Discount
							String disc = driver.findElement(By.xpath(excel.getData(3, 908, 1))).getText();
		
							//Get the Gross Receipt
							String grossRecipt = driver.findElement(By.xpath(excel.getData(3, 909, 1))).getText();
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 902, 1))).getText().equals(checkNum))
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 912, 1))).getText().equals(transactionDate))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 914, 1))).getText().equals(netSales))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 916, 1))).getText().equals(totalTaxAmount))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 918, 1))).getText().equals(incTaxAmount))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 920, 1))).getText().equals(ccServiceCharge))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 922, 1))).getText().equals(disc))
									{}
									else
									{
							...
							try
							{
								if(driver.findElement(By.xpath(excel.getData(3, 901, 1))).isDisplayed())
								{
									...
									if(driver.findElement(By.xpath(excel.getData(3, 924, 1))).getText().equals(grossRecipt))
									{}
									else
									{
				...
				//Get the Reason
				String reason = driver.findElement(By.xpath(excel.getData(3, 927, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 929, 1))).getText().equals(reason))
						{}
						else
						{
				...
				String discName = driver.findElement(By.xpath(excel.getData(3, 931, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 932, 1))).getText().equals(discName))
						{}
						else
						{
				...
				String discType = driver.findElement(By.xpath(excel.getData(3, 933, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 935, 1))).getText().equals(discType))
						{}
						else
						{
				...
				//Get the Amount
				String amt = driver.findElement(By.xpath(excel.getData(3, 936, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						//Get the number of rows
						List<WebElement> filter_Rows = driver.findElements(By.xpath(excel.getData(3, 8901, 1)));
						
						if(driver.findElement(By.xpath(excel.getData(3, 938, 1))).getText().equals(amt))
						{}
						else
						{
				...
				//Get the Quantity
				String quan = driver.findElement(By.xpath(excel.getData(3, 939, 1))).getText();
				...
				try
				{
					if(driver.findElement(By.xpath(excel.getData(3, 893, 1))).isDisplayed())
					{
						...
						if(driver.findElement(By.xpath(excel.getData(3, 941, 1))).getText().contains(quan))
						{}
						else
						{
			...
			public void Discount_Report_Method_Check_View(WebDriver driver) throws Exception
		{
			...
			String ticketNum = driver.findElement(By.xpath(excel.getData(3, 902, 1))).getText();
			//System.out.println("ticketNum"+ticketNum);
			
			//Get the Transaction date for particular User
			String trandate = driver.findElement(By.xpath(excel.getData(3, 903, 1))).getText();
			//System.out.println("trandate"+trandate);
			
			//Get the Total Tax Amount for particular User
			String tTaxAmt = driver.findElement(By.xpath(excel.getData(3, 905, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
			...
			String ccSCharge = driver.findElement(By.xpath(excel.getData(3, 907, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
			...
			String disco = driver.findElement(By.xpath(excel.getData(3, 908, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
			double adisco = Double.parseDouble(disco);
			//System.out.println("adisco"+adisco);
			
			//Get the Gross Receipt for particular User
			String gRecipt = driver.findElement(By.xpath(excel.getData(3, 909, 1))).getText().replaceAll("[a-zA-Z $ ₹ , :]", "");
