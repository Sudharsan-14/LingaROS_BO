	...
	public void Bulk_Update_edit_menu_Item_Price_SingleServing_Size(WebDriver driver) throws Exception
	{
		...
		for(int i = 1; i <= 20; i++)
		{
			...
			if(inp.size() == 1)
			{
				...
				Thread.sleep(7000);//span[contains(.,'Menu Item')]
				...
				driver.findElement(By.xpath("//input[@ng-model='searchText']")).sendKeys(mname);Thread.sleep(500);
	...
	public void Bulk_Update_edit_menu_Item_Price_MultipleServing_Size(WebDriver driver) throws Exception
	{
		...
		for(int i = 1; i <= 20; i++)
		{
			...
			if(inp.size() > 1)
			{
				...
				String actual2 = driver.findElement(By.xpath("//div[@class='ng-binding ng-scope'][1]/div/span")).getText().replaceAll("[a-zA-Z $ Ã¢â€šÂ¹ , :]", "");
				...
				String actual3 = driver.findElement(By.xpath("//div[@class='ng-binding ng-scope'][2]/div/span")).getText().replaceAll("[a-zA-Z $ Ã¢â€šÂ¹ , :]", "");
