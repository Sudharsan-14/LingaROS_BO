...
public class ViewDashBoardReports {
	...
	public void flushTest() throws Exception
	{
		...
		public void viewDashboardElementsForSpecificDate_Sales(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[10]/div/div/div/div/input")).sendKeys(Utility.getReportProperty("Date_Range_From"));
			Thread.sleep(3000);
			//Click the apply button
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[12]/div/button")).click();
		...
		public void viewDashboardElementsForDateRange_Sales(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[11]/div/div/div/div/input[1]")).sendKeys(Utility.getReportProperty("Date_Range_From"));
			Thread.sleep(3000);
			//Clear the End Date
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[11]/div/div/div/div/input[2]")).clear();
			//Enter the End Date
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[11]/div/div/div/div/input[2]")).sendKeys(Utility.getReportProperty("Date_Range_From"));
			Thread.sleep(3000);
			//Click the apply button
			driver.findElement(By.xpath("//form[@name='dashboardForm']/div/div/ul/li[12]/div/button")).click();
