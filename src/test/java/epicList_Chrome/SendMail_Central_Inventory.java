...
public class SendMail_Central_Inventory {
	...
	public static void snedMailWithAttachment()
	{
		...
		try {
			...
			message.setSubject("BO Automation Report for Central Inventory"+dte);
 
			// Create object to add multimedia type content
			BodyPart messageBodyPart1 = new MimeBodyPart();
 
			// Set the body of email
			messageBodyPart1.setText("Hi Team, \n PFA of BO Automation Report for Central Inventory \n Thanks Team");
