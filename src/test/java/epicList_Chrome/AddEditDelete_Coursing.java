...
public class AddEditDelete_Coursing {
	...
	ExtentTest test = rep.startTest("AddEditDelete Coursing");
		...
		public void Coursing_method_add_Coursing(WebDriver driver) throws Exception
		{
			...
			if(driver.findElement(By.xpath("//div[@role='alert']/span/span")).getText().equalsIgnoreCase("Course saved successfully"))
			{
		...
		public void Coursing_method_edit_Coursing(WebDriver driver) throws Exception
		{
			...
			if(wait.until(ExpectedConditions.visibilityOf(up)).getText().equalsIgnoreCase("Course updated successfully"))
			{
		...
		public void Coursing_method_delete_Coursing(WebDriver driver) throws Exception
		{
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Course inactivated successfully"))
			{
			...
			//Check the course	 deleted or not
			if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Course activated successfully"))
			{
