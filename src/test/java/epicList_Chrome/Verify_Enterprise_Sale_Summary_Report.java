	...
	float unknownValue = 00;
		        	...
		        	//Replace all commo's with empty space
				      ...
				      //Check weather the Gross Receipt Report is correct or not
				       ...
				       /* //Get the Gross Receipt value
				        String a = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[9]/span")).getText().replaceAll("[a-zA-Z $ Ã¢â€šÂ¹ , :]", "");
				        ...
				        //Check weather the Gross Receipt Report is correct or not
				        if(s.equals(Utility.getReportPropertyUser("Gross_Receipt").replaceAll("[a-zA-Z $ Ã¢â€šÂ¹ , :]", "")))
				        {
				        	test.log(LogStatus.PASS, "Actual and Expected Sale Summary reports are same for Gross Receipt");
		...
		/*	        //Print number of Rows
				     ...
				     /* //Check weather the Gross Report is correct or not
				      ...
				      //Get the Gross Receipt value
				        String a = driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr[22]/td[9]/span")).getText().replaceAll("[a-zA-Z $ Ã¢â€šÂ¹ , :]", "");
