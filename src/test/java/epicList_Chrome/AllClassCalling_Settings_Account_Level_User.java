...
public class AllClassCalling_Settings_Account_Level_User 
{
	public WebDriver driver;
	ExtentReports rep = ExtentManager.getInstance();
	ExtentTest test = rep.startTest("BO-Settings (New UI) (Account Level User Login)");
	...
	{
		test.log(LogStatus.INFO, "-------Settings Started (Account Level User Login)----");
	}
	/*
	@Test(priority=2)
