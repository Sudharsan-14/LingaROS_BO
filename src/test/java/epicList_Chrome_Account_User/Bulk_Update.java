...
/*		//Click the Products/Items option
	...
	public void Bulk_Update_pagination(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 2293, 1))).click();Thread.sleep(3000);
		...
		driver.findElement(By.xpath(excel.getData(3, 2294, 1))).click();Thread.sleep(3000);
		...
		driver.findElement(By.xpath(excel.getData(3, 2295, 1))).click();Thread.sleep(3000);
		...
		driver.findElement(By.xpath(excel.getData(3, 2296, 1))).click();Thread.sleep(3000);
