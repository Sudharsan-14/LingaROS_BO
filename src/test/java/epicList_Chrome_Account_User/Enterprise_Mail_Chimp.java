		...
		File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
			...
			//	driver.get(Utility.getProperty("Enterprise_Base_URL")+"mailchimp");
				...
				if(Utility.getProperty("Product").equalsIgnoreCase("UPOS"))
				{
					...
					List<String> Browser_Account_Level_UserTabs = new ArrayList<String>(driver.getWindowHandles());
					//switch to new tab
					driver.switchTo().window(Browser_Account_Level_UserTabs .get(1));
...
/*					driver.close();
					driver.switchTo().window(Browser_Account_Level_UserTabs.get(0));*/ 
