...
//						long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
		...
		/*	        //Print number of Rows
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[6]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Net_Sale")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[7]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[8]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Inclusive_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[9]/span")).getText().equals(Utility.getReportPropertyUser("CC_Service_Charge")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[10]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Discount")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[11]/span")).getText().equals(Utility.getReportPropertyUser("Gross_Receipt")))
				        {
			...
			public void Sale_Saummary_Sale_method_Report_For_Specific_Date_WithService_Type(WebDriver driver) throws Exception
			{
				...
				*/
				...
				Thread.sleep(3000);
				//Click the OrderType 		
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul")).click();
				Thread.sleep(3000);
				//Enter the Service_Type
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul/li/input")).sendKeys(Utility.getReportPropertyUser("Service_Type"));
				
				Thread.sleep(1000);
				//Press the Service Type
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul/li/input")).sendKeys(Keys.ENTER);
...
//				
				...
				WebElement check1 = driver.findElement(By.xpath(excel.getData(3, 1584, 1)));
				
				if (wait1.until(ExpectedConditions.visibilityOf(check1)).isDisplayed())
				{
...
//					long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
					...
					try
					{
						...
						WebElement ele12=driver.findElement(By.xpath(excel.getData(3, 704, 1)));
						
						//Check weather the report is available for the selected time period
						if(wait2.until(ExpectedConditions.visibilityOf(ele12)).isDisplayed())
						{
							test.log(LogStatus.FAIL, "Sale Summary Report is not available for the Required Date Range");
						}
					}
					catch(Exception fd)
					{
						...
						System.out.println("Time in Millisecomds : "+totalTime2);
						double ActualfinishTime2 = TimeUnit.MILLISECONDS.toMinutes(totalTime2);
//						long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
						long ActualfinishTimeDouble12 = (totalTime2/1000)/6;
						System.out.println("MilSEc to Mins basic conversion : "+ActualfinishTimeDouble12);
						test.log(LogStatus.INFO, "Total Time : "+ActualfinishTimeDouble12);
			...
			public void Sale_Saummary_Sale_method_Report_For_Specific_Date_WithSearchAndServiceType(WebDriver driver) throws Exception
			{
				...
				Thread.sleep(3000);
				//Enter the Service_Type
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul/li/input")).sendKeys("QSR");
				...
				Thread.sleep(3000);
				//Enter the Service_Type
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul/li/input")).sendKeys("Phone - DELIVERY");
				...
				Thread.sleep(3000);
				//Enter the Service_Type
				driver.findElement(By.xpath("//select[@ng-model='query.serviceTypes']/../div/ul/li/input")).sendKeys("Web - DELIVERY");
				...
				{
					WebDriverWait wait1=new WebDriverWait(driver, 30);
					WebElement ele11=driver.findElement(By.xpath(excel.getData(3, 1584, 1)));
...
//					long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
					...
					WebDriverWait wait2=new WebDriverWait(driver, 30);
					WebElement ele12=driver.findElement(By.xpath(excel.getData(3, 1587, 1)));
					if(wait2.until(ExpectedConditions.visibilityOf(ele12)).isDisplayed())
			...
			public void Sale_Saummary_Sale_method_Report_For_Specific_Date_WithService_Type_And_Dynamic_Report(WebDriver driver) throws Exception
			{
				...
				*/
				...
				catch(Exception fd)
				{
					...
					WebDriverWait wait1=new WebDriverWait(driver, 30);
					WebElement ele11=driver.findElement(By.xpath(excel.getData(3, 1569, 1)));
					if(wait1.until(ExpectedConditions.visibilityOf(ele11)).isDisplayed()) {
