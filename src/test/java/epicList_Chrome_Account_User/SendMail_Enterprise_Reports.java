...
public class SendMail_Enterprise_Reports {
	...
	public static void snedMailWithAttachment()
	{
		...
		try {
			...
			message.setSubject("BO Automation Report for Enterprise Reports"+dte);
 
			// Create object to add multimedia type content
			BodyPart messageBodyPart1 = new MimeBodyPart();
 
			// Set the body of email
			messageBodyPart1.setText("Hi Team, \n PFA of BO Automation Report for Enterprise Reports attached with Screenshots \n Thanks Team");
