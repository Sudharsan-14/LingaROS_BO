	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			/*	Thread.sleep(2000);
				...
				Thread.sleep(3000);
				//Enter the Users URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"report/void");
			...
			public void Node_Report_Method_Verify(WebDriver driver) throws Exception
			{
				...
				//Enter the date
				driver.findElement(By.xpath(excel.getData(3, 1602, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
	
				Thread.sleep(2000);
				//Clear the date field
				driver.findElement(By.xpath(excel.getData(3, 1603, 1))).clear();
				//Enter the date
				driver.findElement(By.xpath(excel.getData(3, 1603, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
