...
public class Inventory_Menu_Item {
	...
	ExtentTest test = rep.startTest("Inventory_Menu_Item");
		...
		//Get the URl
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"inventory_menuItems");
		...
		public void Inventory_Menu_Items_verify_UnLinked_TO_Linked(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(2, 478, 1))).click();
			//Press the Enter button
			Thread.sleep(1000);driver.findElement(By.xpath(excel.getData(2, 479, 1))).sendKeys("FOOD");
			Thread.sleep(1000);driver.findElement(By.xpath(excel.getData(2, 479, 1))).sendKeys(Keys.ENTER);
			...
			//Press the Enter button
			Thread.sleep(1000);
			driver.findElement(By.xpath(excel.getData(2, 475, 1))).click();
			...
			//Enter Reciept Unit
			driver.findElement(By.xpath(excel.getData(2, 477, 1))).click();
			//Press the Enter button
			...
			driver.findElement(By.xpath(excel.getData(2, 464, 1))).sendKeys("1");
			...
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(2, 471, 1))).sendKeys(Keys.ARROW_DOWN);
			//Enter item
			...
			//Press the Enter button
			driver.findElement(By.xpath(excel.getData(2, 473, 1))).sendKeys(Keys.ARROW_DOWN);
			//Enter Recipe 
			...
			driver.findElement(By.xpath(excel.getData(2, 515, 1))).clear();
			//Enter the required Item
			driver.findElement(By.xpath(excel.getData(2, 515, 1))).sendKeys("Test");
			
			Thread.sleep(1000);  
			//clear the Price per Unit Option
			driver.findElement(By.xpath(excel.getData(2, 516, 1))).clear();
			//Enter the Price per Unit
			driver.findElement(By.xpath(excel.getData(2, 516, 1))).sendKeys("500");
			
			Thread.sleep(1000);
			//Clear the Quantity
			driver.findElement(By.xpath(excel.getData(2, 453, 1))).clear();
			//Enter the required quantity
			driver.findElement(By.xpath(excel.getData(2, 453, 1))).sendKeys("2");
...
*/
			...
			driver.findElement(By.xpath(excel.getData(3, 2271, 1))).click();
			
		//	Thread.sleep(2500);
			WebElement ele=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
			WebDriverWait wait=new WebDriverWait(driver,60);
			//Check whether the inventory item updated or not
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Menu item Updated"))
			{
	...
	*/
			...
			//Check whether the inventory item updated or not
			if(driver.findElement(By.xpath(excel.getData(3, 39, 1))).getText().equalsIgnoreCase("Menu item Updated"))
			{
				test.log(LogStatus.PASS, "Menu item Updated Sucessfully");
			}
			else
	...
	/*		Thread.sleep(3500);
		...
		*/	
		...
		public void Inventory_Menu_Items_verifyActive_InActiveButton_Sub_Recipe(WebDriver driver) throws Exception
		{
			...
			if(!driver.findElement(By.cssSelector(excel.getData(2, 469, 4))).isDisplayed())
			{
