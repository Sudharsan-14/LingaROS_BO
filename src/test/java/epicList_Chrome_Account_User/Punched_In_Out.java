	...
	ExtentTest test = rep.startTest("Punched_In_Out");
		...
		public void Usermanagement_ForcedPunchInOut_OpenPage(WebDriver driver) throws Exception
			...
			ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
						...
						driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"employeeList");
						try
						{
						Thread.sleep(3000);
						...
						driver.findElement(By.xpath(excel.getData(3, 623, 1))).sendKeys(Utility.getReportPropertyUser("Punchin/out_name"));
						//Press the Enter Key              
						...
						driver.findElement(By.xpath(excel.getData(3, 625, 1))).sendKeys(Utility.getReportPropertyUser("Punchin/out_Date"));
		...
		public void Usermanagement_ForcedPunchInOut_addTimeEvent(WebDriver driver) throws Exception
			...
			ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
						...
						driver.findElement(By.name(excel.getData(3, 632, 3))).sendKeys(Utility.getReportPropertyUser("Punchin/out_Date"));
						...
						driver.findElement(By.name(excel.getData(3, 634, 3))).sendKeys(Utility.getReportPropertyUser("Punchin/out_Date"));
