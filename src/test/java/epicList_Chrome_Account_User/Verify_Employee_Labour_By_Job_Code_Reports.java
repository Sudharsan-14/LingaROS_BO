...
public class Verify_Employee_Labour_By_Job_Code_Reports{
	...
	/*			//Click the Reports option
				...
				//Enter the Users URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"laborReport");
	
				Thread.sleep(5000);
				try
				{
				//Check Labour By Job Code Report page opened or not
				if(driver.findElement(By.xpath(excel.getData(3, 2272, 1))).getText().equalsIgnoreCase("Labor By Job Code"))
				{
			...
			public void Employee_Labour_By_Job_Code_Report_Method_verifyDailyReport(WebDriver driver) throws Exception
			{
			    ...
			    //Enter the Date
			    driver.findElement(By.xpath(excel.getData(1, 1555, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
	
			    Thread.sleep(1000);
			    //Clear the Date field
			    driver.findElement(By.xpath(excel.getData(1, 1556, 1))).clear();
			    //Enter the Date
			    driver.findElement(By.xpath(excel.getData(1, 1556, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
				...
				/*		Verify_Employee_Attendance_Report ac=new Verify_Employee_Attendance_Report();
						ac.Get_Attendance_Report_Data();
					*/	
						String scnShot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BASE64);
						String s="data:image/png;base64,"+scnShot;
						test.log(LogStatus.INFO,test.addScreenCapture(s));
