	...
	float unknownValue = 00;
		...
		/*		//Click the Reports option
				...
				public void Employee_Role_Based_Payroll_Report_Method_verifyDailyReport(WebDriver driver) throws Exception
				{
				    ...
				    //Enter the Date
				    driver.findElement(By.xpath(excel.getData(1, 1555, 1))).sendKeys(Utility.getReportPropertyUser("Payroll_Date_Range_From"));
		
				    Thread.sleep(1000);
				    //Clear the Date field
				    driver.findElement(By.xpath(excel.getData(1, 1556, 1))).clear();
				    //Enter the Date
				    driver.findElement(By.xpath(excel.getData(1, 1556, 1))).sendKeys(Utility.getReportPropertyUser("Payroll_Date_Range_To"));
