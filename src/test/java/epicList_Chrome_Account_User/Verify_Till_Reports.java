...
public class Verify_Till_Reports {
	...
	float unknownValue = 00;
		...
		public void Till_Report_Method_viewpage(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(3000);
			//Enter the Users URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"tillReport");
		...
		{   
			...
			driver.findElement(By.xpath(excel.getData(1, 1009, 1))).sendKeys(Utility.getReportPropertyUser("Till_Date_Range_From"));
			
			
			//Clear the date field
			driver.findElement(By.xpath(excel.getData(1, 1010, 1))).clear();
			//Select the required Specific date
			driver.findElement(By.xpath(excel.getData(1, 1010, 1))).sendKeys(Utility.getReportPropertyUser("Till_Date_Range_To"));
