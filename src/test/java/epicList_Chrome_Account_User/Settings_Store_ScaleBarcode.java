...
public WebDriver driver;
	...
	ExtentTest test = rep.startTest("Settins_Store_Scale_Barcode");
		...
		{	
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"newScaleBarCodeSettings");
			Thread.sleep(5000);
			try
			{
	...
	//	Thread.sleep(2000);
		...
		WebDriverWait wait=new WebDriverWait(driver,50);
		 ...
		 if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Barcode Setting Saved Successfully"))
			{
		 ...
		 Thread.sleep(2000);
			...
			WebDriverWait wait1=new WebDriverWait(driver,50);
			 ...
			 if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Barcode Setting Saved Successfully"))
				{
