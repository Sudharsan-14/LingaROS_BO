...
public class Verify_Till_Cash_Transaction_Reports {
	public WebDriver driver;
		...
		/*	//Click the Reports option
			...
			Thread.sleep(3000);
			//Enter the Users URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"cashTransactionReport");
		...
		/*	  	html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));-
		    ...
		    driver.findElement(By.xpath(excel.getData(1, 998, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
		
		    //Clear the Date field
		    driver.findElement(By.xpath(excel.getData(1, 999, 1))).clear();
		    //Enter the number of days
		    driver.findElement(By.xpath(excel.getData(1, 999, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
