...
*/
		...
		driver.findElement(By.xpath(excel.getData(3, 2319, 1))).click();
		//Enter the required Time Period
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys("Always");
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath(excel.getData(5, 326, 1))).click();
		//Press the Enter button
...
/*		//Clear the Price option
		...
		setPrice2.selectByVisibleText("ADD GLASS");
...
//		String s1 = driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText();System.out.println(s1);
		...
		//Check whether the new form loaded or not
		if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Menu item saved successfully"))
		{
	...
	public void Product_And_Item_method_editMenuItem(WebDriver driver) throws Exception
	{
		...
		try
		{
			if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div/div[4]/div/div[2]/div[2]/form/div/ng-form/div[1]/div[16]/div/div/table/tbody/tr[2]/td[2]/table/tbody/tr/th[3]/a")).isDisplayed())
			{
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div/div[4]/div/div[2]/div[2]/form/div/ng-form/div[1]/div[16]/div/div/table/tbody/tr[2]/td[2]/table/tbody/tr/th[3]/a")).click();
		...
		Thread.sleep(3000);
		//Enter the required serving size level
		driver.findElement(By.xpath(excel.getData(5, 362, 1))).click();
		Thread.sleep(3000);
		//Press the Enter button
		...
		//Enter the required price
		driver.findElement(By.name(excel.getData(5, 363, 3))).sendKeys("350");
	...
	//	startDay.selectByVisibleText("WEDNESDAY");
		...
		if(driver.findElement(By.xpath(excel.getData(3, 2313, 1))).getText().equalsIgnoreCase("AM"))
		{
			Thread.sleep(2500);
			//Click the AM or PM option in the End Time
			driver.findElement(By.xpath(excel.getData(3, 2314, 1))).click();
		}
		else
		{
			Thread.sleep(2500);
			//Click the AM or PM option in the Start Time
			driver.findElement(By.xpath(excel.getData(3, 2313, 1))).click();
		}
		...
		try
		{
			if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div/div[4]/div/div[2]/div[2]/form/div/ng-form/div[2]/div[1]/div/div[1]/div/div[2]/div[5]/table/tbody/tr[2]/td[2]/div[2]/input")).isDisplayed())
			{
				driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div/div/div/div/div/div/div[4]/div/div[2]/div[2]/form/div/ng-form/div[2]/div[1]/div/div[1]/div/div[2]/div[5]/table/tbody/tr[2]/td[2]/div[2]/input")).sendKeys("500");
			}
		}
		catch(Exception k) {}
	...
	//	Thread.sleep(3000);
		...
		if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Menu item updated successfully"))
		{
	...
	public void Product_And_Item_method_addMenuItemByCopyMenuItem(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 2319, 1))).click();
		//Enter the required Time Period
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys("Days of Month");
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys(Keys.ENTER);
	...
	public void Product_And_Item_method_cancelMenuItemByCopyMenuItem_Basic(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 2321, 1))).click();
		Thread.sleep(3000);
	...
	try {	Thread.sleep(3000);
		//Click the next button
		driver.findElement(By.cssSelector(excel.getData(5, 308, 4))).click();}catch(Exception m) {}
	...
	public void Product_And_Item_method_saveMenuItemByCopyMenuItem(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(excel.getData(3, 2319, 1))).click();
		//Enter the required Time Period
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys("Date Range");
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys(Keys.ENTER);
		/*//Click the Applicable Time Period field
...
// enable the time restriction
	...
	//	Select measureType= new Select(driver.findElement(By.name(excel.getData(5, 282, 3))));
		...
		driver.findElement(By.xpath(excel.getData(3, 2319, 1))).click();
		//Enter the required Time Period
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys("Specific date");
		//Press the Enter button
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys(Keys.ENTER);
		//Click the Required Date form the Calendar
		//driver.findElement(By.xpath(excel.getData(5, 383, 1))).click();
		...
		//Enable or disable the Restriction Time Period option
		if(driver.findElement(By.xpath(excel.getData(5, 374, 1))).isSelected())
		{
	...
	//	String s1 = driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText();System.out.println(s1);
		...
		driver.findElement(By.xpath(excel.getData(3, 2319, 1))).click();
		//Enter the required Time Period
		driver.findElement(By.xpath(excel.getData(3, 2320, 1))).sendKeys("Start date time & end date time");
	...
	//Press the Enter Key in the Applicable time period option field
		...
		Thread.sleep(2500);
		//Click the Days of a Week option
		driver.findElement(By.xpath(excel.getData(3, 2322, 1))).click();
		//Enter the Required Date
		driver.findElement(By.xpath(excel.getData(3, 2323, 1))).sendKeys("FRIDAY");
		//Press the Enter Key
		driver.findElement(By.xpath(excel.getData(3, 2323, 1))).sendKeys(Keys.ENTER);

		driver.findElement(By.tagName("html")).sendKeys(Keys.HOME);
		
		Thread.sleep(500);
		//Enable or disable the Restriction Time Period option
				if(driver.findElement(By.xpath(excel.getData(3, 2292, 1))).isSelected())
				{
...
//		String s2 = driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText();System.out.println(s2);*/
	//	Thread.sleep(4000);
		...
		//Check whether the new form loaded or not
		if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Menu item saved successfully"))
		{
			test.log(LogStatus.PASS, "New Menu Item is saved Successfully");
		}
		else
	...
	//	String s3 = driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText();System.out.println(s3);
		...
		WebElement ele4=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
		WebDriverWait wait4=new WebDriverWait(driver,60);
		
		//Check whether the new form loaded or not
		if(wait4.until(ExpectedConditions.visibilityOf(ele4)).getText().equalsIgnoreCase("Menu item saved successfully"))
		{
			test.log(LogStatus.PASS, "New Menu Item is saved Successfully");
		}
		else
...
//		String s4 = driver.findElement(By.xpath(excel.getData(5, 219, 1))).getText();System.out.println(s4);
		...
		WebElement ele11=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
		WebDriverWait wait11=new WebDriverWait(driver,60);
		
		//Check whether the new form loaded or not
		if(wait11.until(ExpectedConditions.visibilityOf(ele11)).getText().equalsIgnoreCase("Menu item saved successfully"))
		{
			test.log(LogStatus.PASS, "New Menu Item is saved Successfully");
		}
		else
	...
	//	Thread.sleep(4501);
		...
		WebElement ele3=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
		WebDriverWait wait3=new WebDriverWait(driver,60);
		
		//Check whether the new form loaded or not
		if(wait3.until(ExpectedConditions.visibilityOf(ele3)).getText().equalsIgnoreCase("Menu item saved successfully"))
		{
			test.log(LogStatus.PASS, "New Menu Item is saved Successfully");
		}
		else
