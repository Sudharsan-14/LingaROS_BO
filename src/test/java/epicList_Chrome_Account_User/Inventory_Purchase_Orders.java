...
public class Inventory_Purchase_Orders {
		...
		*/		
				...
				driver.findElement(By.xpath(excel.getData(3, 2303, 1))).click();
	...
	/*			//Clear the Search Field
		...
		*/		
				...
				//Check whether the Receive information updated or not
				if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Receive information updated."))
				{
		...
		//		driver.findElement(By.xpath(excel.getData(3, 40, 1))).sendKeys("Sysco Food");
				...
				//Check whether the order is canceled or not
				if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("RECEIVED"))
				{
