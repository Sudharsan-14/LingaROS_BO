...
public class Verify_Customer_Performance_Report {
	...
	public WebDriver driver;
		...
		public void CustomerPerformance_Report_Method_viewpage(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(3000);
			//Enter the Users URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"customerPreferenceReport");
		...
		public void CustomerPerformance_Report_Method_verify(WebDriver driver) throws Exception
		{
		    ...
		    driver.findElement(By.xpath(excel.getData(3, 1131, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
		
		    Thread.sleep(2000);
		    //Clear the Date field
		    driver.findElement(By.xpath(excel.getData(3, 1132, 1))).clear();
		    //Enter the required date
		    driver.findElement(By.xpath(excel.getData(3, 1132, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
