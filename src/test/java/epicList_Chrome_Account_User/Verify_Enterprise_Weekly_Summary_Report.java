...
public class Verify_Enterprise_Weekly_Summary_Report {
	...
	//	SendMail.snedMailWithAttachment();    
		...
		{ 
			...
			driver.findElement(By.xpath(excel.getData(3, 2160, 1))).sendKeys(Utility.getReportPropertyUser("Store"));
			...
			WebElement ele11=driver.findElement(By.xpath(excel.getData(3, 1517, 1)));
...
//				test.log(LogStatus.INFO, "Total Time : "+ActualfinishTimeDouble1);
				...
				for(int i = 2; i <= rows.size(); i++)
				{
					if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+i+"]/td[1]")).getText().equalsIgnoreCase("Gross Sales"))
					{
			        	...
			        	String expected1 = Utility.getReportPropertyUser("This_Weekly_Gross_Sale").replace("[,\\₹]", "");
						...
						if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+i+"]/td["+Column.size()+"]")).getText().equals(Utility.getReportPropertyUser("This_Weekly_Gross_Sale")))
						{
				...
				for(int i = 2; i <= rows.size(); i++)
				{
					if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+i+"]/td[1]")).getText().equalsIgnoreCase("Total Net Sales"))
					{
			        	...
			        	//Replace all commo's with empty space
			        	String expected2 = Utility.getReportPropertyUser("This_Weekly_Net_Sale").replace("[,\\₹]", "");
						...
						Thread.sleep(2000);
						//Check the Net Sale
						if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+i+"]/td["+Column1.size()+"]")).getText().equals(Utility.getReportPropertyUser("This_Weekly_Net_Sale")))
						{
