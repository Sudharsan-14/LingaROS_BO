...
*/			
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"department");
		...
		public void Department_method_delete_Department(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(2000);driver.findElement(By.cssSelector("a.btn.btn-small.btn-success")).click();
			
			Thread.sleep(3000);
			//Check the menu item deleted or not
			if(driver.findElement(By.xpath("//div[@role='alert']/span/span")).getText().equalsIgnoreCase("Department Inactivated Successfully"))
			{
			...
			if(driver.findElement(By.xpath("//div[@role='alert']/span/span")).getText().equalsIgnoreCase("Department Activated Successfully"))
			{
