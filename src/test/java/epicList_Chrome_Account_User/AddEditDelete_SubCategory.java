...
*/
			...
			driver.findElement(By.xpath(excel.getData(0, 164, 1))).click();
			//Press the Enter Key
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Sub Category Saved Successfully"))
			{
