...
/*					Utility us1=new Utility();
			...
			//	Thread.sleep(3500);
				...
				if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Item Service Charge Saved Successfully"))
				{
			...
			public void item_Service_Charge_delete(WebDriver driver) throws Exception
			{
				...
				if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Item Service Charge inactivated successfully"))
				{
				...
				if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Item Service Charge activated successfully"))
				{
