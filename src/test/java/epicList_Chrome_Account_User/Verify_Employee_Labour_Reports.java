	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			/*	//Click the Reports option
				...
				Thread.sleep(3000);
				//Enter the Users URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"labour");
			...
			public void Employee_Labour_Report_Method_verifyDailyReport(WebDriver driver) throws Exception
			{
			    ...
			    //Enter the Date
			    driver.findElement(By.xpath(excel.getData(1, 1569, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));

			    Thread.sleep(1000);
			    //Clear the Date field
			    driver.findElement(By.xpath(excel.getData(1, 1570, 1))).clear();
			    //Enter the Date
			    driver.findElement(By.xpath(excel.getData(1, 1570, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
