...
public class AddEditDelete_Gratuity {
	...
	{ 
		...
		//Thread.sleep(5000);
	driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"gratuity");
	Thread.sleep(8000);
	...
	public void Gratuity_method_addGratuities_Fixed(WebDriver driver) throws Exception
	{
		...
		if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Gratuity saved successfully"))
		{
	...
	public void Gratuity_method_editGratuity(WebDriver driver) throws Exception
	{
		...
		if(wait.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Gratuity updated successfully"))
		{
	...
	public void Gratuity_method_deleteGratuity(WebDriver driver) throws Exception
	{
		...
		if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Gratuity inactivated successfully"))
		{
		...
		if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Gratuity activated successfully"))
		{
