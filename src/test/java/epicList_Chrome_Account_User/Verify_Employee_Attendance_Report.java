...
public class Verify_Employee_Attendance_Report {
	...
	float unknownValue = 00;
		...
		//	Get_Attendance_Report_Data(driver);
			...
			public void Employee_Attendance_Report_Method_OpenPage(WebDriver driver) throws Exception
			{
				...
				Thread.sleep(3000);
				//Enter the Users URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"report/attendance");
				...
				//Get_Attendance_Report_Data(EmployeeList);
			//	List<WebElement> EmployeeList = null;
			...
			public void Employee_Attendance_Report_Method_For_InTime(WebDriver driver) throws Exception
			{
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Time Starts-------------");
			  ...
			  //Click the Run
				...
				//	Get_Attendance_Report_Data();
					...
					String hours = driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[6]")).getText();
...
//					test.log(LogStatus.INFO, String.format(format, args));
				//	String json = "{'foo' : 'bar', 'foos' : ['b','a','r'], 'bar' : {'foo':'bar', 'bar':false,'foobar':1234}}";
				//	test.log(LogStatus.INFO,(MarkupHelper.createCodeBlock(json, CodeLanguage.JSON)));
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Time Ends-------------");
			...
			public void Employee_Attendance_Report_Method_For_InHours(WebDriver driver) throws Exception
			{
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Hours Starts-------------");
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Hours End-------------");
			...
			public void Employee_Attendance_Report_Method_For_InTime_With_Dynamic_Report(WebDriver driver) throws Exception
			{
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Time with Dyanamic Starts-------------");
			  ...
			  //Click the Run
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In Time with Dynamic Starts-------------");
			...
			public void Employee_Attendance_Report_Method_For_InHours_With_Dynamic_Report(WebDriver driver) throws Exception
			{
				...
				test.log(LogStatus.INFO, "-----------------Employee Report for In hours with Dynamic Starts-------------");
		...
		//	@Test(priority = 101)
			public List Get_Attendance_Report_Data() throws Exception
			{
				
				ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));

				
				List<WebElement> EmployeeList=driver.findElements(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr"));
				int rowSize=EmployeeList.size();
				System.out.println("Total Rows : "+rowSize);
			//	List<String> EmployeeList=new ArrayList<String>();
				for(int i = 1;i<=rowSize-1;i++)
				{
					for(WebElement EmployeeName:EmployeeList)
					{
			
						List EmpList=driver.findElements(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+i+"]/td[2]"));
						test.log(LogStatus.INFO,"S No :"+i+" Employee Name : "+driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+i+"]/td[2]")).getText());
						//test.log(LogStatus.INFO, "Employees  " +EmployeeName.getText());
						//EmployeeList=str.toString();
