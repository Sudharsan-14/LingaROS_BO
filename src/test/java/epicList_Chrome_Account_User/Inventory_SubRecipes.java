...
public WebDriver driver;
	...
	ExtentTest test = rep.startTest("Inventory_SubRecipes");
		...
		public void Inventory_Sub_Recipes_openpage(WebDriver driver) throws Exception
		{
			...
			//Get the URl
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"subRecipes");
		...
		try
		{
			...
			{
				test.log(LogStatus.PASS, "New SubRecipe Saved Sucessfully");
			}
			else
			{
				test.log(LogStatus.FAIL, "New SubRecipe Save Failed");
			}
			wb.close();
			Thread.sleep(5000);
		}
	...
	*/	
			...
			{
				test.log(LogStatus.PASS, "New SubRecipe updated Sucessfully");
			}
			else
			{
				test.log(LogStatus.FAIL, "New SubRecipe updated Failed");
			}
			wb.close();
	...
	//		driver.findElement(By.xpath(excel.getData(2, 59, 1))).sendKeys("Kilo gram");
		...
		/*	
			Thread.sleep(5000);
			//To prepare SubRecipe
			test.log(LogStatus.INFO, "Preparing Sub Recipes for Mapped with Sub Recipe and Manual Entry starts");
			//Get the URl
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"order/create/SUBRECIPE");
		    ...
		    driver.findElement(By.xpath(excel.getData(3, 1238, 1))).sendKeys(Utility.getProperty("Inventory_SubRecipe_Name")+"1"+"1");
		  //Enter the SubRecipe option
		   ...
		   Thread.sleep(2000);
			...
			Thread.sleep(5000);
			test.log(LogStatus.INFO, "Preparing Sub Recipe with Mapped Sub Recipe and Manual Entry End");
			//Get the URl
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"subRecipes");
			*/
			Thread.sleep(5000);
		...
		try {	
			...
			if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Sub Recipe inactivated successfully"))
			{
				test.log(LogStatus.PASS, "New SubRecipe deleted Sucessfully");
			}
			else
			{
				test.log(LogStatus.FAIL, "New SubRecipe deleted Failed");
			}
		}
		catch(Exception k) {}
			wb.close();
		...
		//	Thread.sleep(6000);		
			...
			if(wait2.until(ExpectedConditions.visibilityOf(ac)).getText().equalsIgnoreCase("Sub Recipe activated successfully"))
			{
		...
		public void Inventory_Sub_Recipes_closeButton_Sub_Recipe(WebDriver driver) throws Exception
		{
			...
			{
				test.log(LogStatus.PASS, "New SubRecipe Canceled Successfully");
			}
			else
			{
				test.log(LogStatus.FAIL, "New SubRecipe Canceled Failed");
			}
			wb.close();
			Thread.sleep(5000);
		}
