...
//						long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
		...
		/*		        //Print number of Rows
			        	...
			        	//Replace all commo's with empty space
			        	String expected2 = Utility.getReportPropertyUser("Sub_Category_Sale_Report_Quantity").replace(",", "");
			        	...
			        	//Replace all commo's with empty space
			        	String expected4 = Utility.getReportPropertyUser("Sub_Category_Sale_Report_Discount").replace(",", "");
			        	...
			        	//Replace all commo's with empty space
			        	String expected5 = Utility.getReportPropertyUser("Sub_Category_Sale_Report_Percentage_Of_Sale").replace(",", "");
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[3]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Quantity")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[4]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[5]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Discount")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[6]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Percentage_Of_Sale")))
				        {
			...
			public void Sub_Category_Sale_method_For_Specific_Date_With_Quantity_Sort(WebDriver driver) throws Exception
			{
				...
				//Enter the date
				driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[1]")).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));

				Thread.sleep(2000);
				//Clear the date field
				driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[2]")).clear();
				//Enter the date
				driver.findElement(By.xpath("//form[@name='saleReport']/div[4]/div/div/input[2]")).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
