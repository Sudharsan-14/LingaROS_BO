...
public class AddEditDelete_GiftCard {
	...
	ExtentTest test = rep.startTest("AddEditDelete_GiftCard");
		...
		public void Giftcard_method_addGiftCard(WebDriver driver) throws Exception
		{
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Gift Card Saved Successfully"))
			{
		...
		public void Giftcard_method_editGiftCard(WebDriver driver) throws Exception
		{
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Gift card updated successfully"))
			{
		...
		//	Thread.sleep(5000);
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Gift card inactivated successfully"))
			{
			...
			if(wait1.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Gift card activated successfully"))
			{
		...
		public void Giftcard_method_sameName(WebDriver driver) throws Exception
		{
			...
			//Check whether the Product Item updated successfully or not
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Validation Error(s)"))
			{
