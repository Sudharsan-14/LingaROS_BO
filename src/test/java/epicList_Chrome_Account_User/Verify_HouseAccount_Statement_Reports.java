	...
	float unknownValue = 00;
			...
			public void Employee_HAStatement_Report_Method_Openpage(WebDriver driver) throws Exception
		{
			...
			*/
			...
			Thread.sleep(3000);
			//Enter the Users URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"haStatementReport");
			...
			public void Employee_HAStatement_Report_Method_verifyALL(WebDriver driver) throws Exception
			{
			    ...
			    driver.findElement(By.xpath(excel.getData(1, 972, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
	
			    Thread.sleep(2000);
			    //Clear the number of day field
			    driver.findElement(By.xpath(excel.getData(1, 973, 1))).clear();
			    //Enter the number of days
			    driver.findElement(By.xpath(excel.getData(1, 973, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
