...
public class Settings_Notification_Settings {
	...
	public void Notification_Settings_Method_open(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(5000);
			//Enter the URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"newNotificationSettings");
	...
	public void Notification_Settings_Method_edit(WebDriver driver) throws Exception
		...
		else
		{
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Notification Settings updated Successfully"))
			{
