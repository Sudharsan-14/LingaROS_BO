...
public class Verify_Refund_Report {
	...
	public WebDriver driver;
		...
		public void Refund_Report_Method_Openpage(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(3000);
			//Enter the Users URL
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"refundReport");
		...
		public void Refund_Report_Method_verify_By_Payment_Type(WebDriver driver) throws Exception
		{
			...
			driver.findElement(By.xpath(excel.getData(1, 1100, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
			
			   //Clear the Date Field
			driver.findElement(By.xpath(excel.getData(1, 1101, 1))).clear();
			//Enter the specific date
			driver.findElement(By.xpath(excel.getData(1, 1101, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
