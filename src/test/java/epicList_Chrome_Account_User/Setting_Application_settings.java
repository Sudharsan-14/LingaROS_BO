...
import org.testng.ITestResult;
	...
	public class Setting_Application_settings {
			...
			public void Application_Settings_Method_edit(WebDriver driver) throws Exception
				...
				ExcelDataConfig excel = new ExcelDataConfig(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
					...
					if(driver.findElement(By.name(excel.getData(5, 402, 3))).isSelected())
					{
				...
				//    driver.findElement(By.xpath(excel.getData(5, 404, 1))).click();
					...
					//check whether the Restrict Gift Card Tip button Enabled or not
					if(driver.findElement(By.xpath(excel.getData(3, 2383, 1))).isSelected())
					{
					...
					{
						Thread.sleep(1000);
						//Enable Restrict Gift Card Tip
						driver.findElement(By.xpath(excel.getData(3, 2383, 1))).click();
					}
					
					//Check whether the Employee Tip Out Deducted from Cash Expected on Reports
					if(driver.findElement(By.xpath(excel.getData(5, 407, 1))).isSelected())
					{
					...
					//Check whether the Gratuity Line in Credit card screen enabled or not
					if(driver.findElement(By.name(excel.getData(5, 408, 3))).isSelected())
					{
					...
					//Check whether Customer Nationality enabled or not
					if(driver.findElement(By.xpath(excel.getData(5, 409, 1))).isSelected())
					{
					...
					//Check wwther the Show Popup for Tax Exempt Reference Id enabled or not
					if(driver.findElement(By.xpath(excel.getData(5, 410, 1))).isSelected())
					{
					...
					//Check whether the Check Number will Not Reset Daily enabled or not
					if(driver.findElement(By.xpath(excel.getData(5, 411, 1))).isSelected()) 
					{
				...
				//Auto log off
					driver.findElement(By.xpath(excel.getData(5, 412, 1))).clear();
					//Auto log off time
					driver.findElement(By.xpath(excel.getData(5, 412, 1))).sendKeys("1800");
					...
					//Check whether the Auto generate house account number
					if(driver.findElement(By.xpath(excel.getData(5, 415, 1))).isSelected())
					{
					...
					//Check whether the Auto Close day report enabled or not
					if(driver.findElement(By.xpath(excel.getData(5, 416, 1))).isSelected())
					{
	...
	driver.findElement(By.xpath(excel.getData(5, 425, 1))).click();					
				...
				//	driver.findElement(By.tagName(excel.getData(5, 174, 5))).sendKeys(Keys.END);
					...
					Thread.sleep(1500);
					//Check whether the Show Inactive Driver button enabled or not
					if(driver.findElement(By.xpath(excel.getData(3, 2384, 1))).isSelected())
					{
						
					}
					else
					{
						//Enable the Show Inactive Drivers button
						driver.findElement(By.xpath(excel.getData(3, 2384, 1))).click();
					}
					...
					driver.findElement(By.name(excel.getData(5, 431, 3))).sendKeys("BarTab");
					Thread.sleep(1000);
				...
				//	driver.findElement(By.tagName(excel.getData(5, 174, 5))).sendKeys(Keys.END);
					...
					//Pos Custom Field 1
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[1]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[1]/div[2]/div/div/div/input")).sendKeys("Print");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[1]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					//pos Custom field 2
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[2]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[2]/div[2]/div/div/div/input")).sendKeys("Discount");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[2]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					//pos Custom field 3
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[3]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[3]/div[2]/div/div/div/input")).sendKeys("Search");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[3]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					//pos Custom field 4
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[4]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[4]/div[2]/div/div/div/input")).sendKeys("Cash");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[4]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					//pos Custom field 5
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[5]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[5]/div[2]/div/div/div/input")).sendKeys("Modify");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[5]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					//pos Custom field 6
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[6]/div[2]/div/a")).click();
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[6]/div[2]/div/div/div/input")).sendKeys("Order");
					driver.findElement(By.xpath("//p[contains(.,'POS Custom Button')]/../../div/div/div[6]/div[2]/div/div/div/input")).sendKeys(Keys.ENTER);
					...
					//Check whether the Store Level Customer Enabled or not
					if(driver.findElement(By.xpath(excel.getData(3, 2471, 1))).isSelected())
					{
						
					}
					else
					{
						driver.findElement(By.xpath(excel.getData(3, 2471, 1))).click();
					}
					
					//Click the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2386, 1))).click();
					//Select the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2387, 1))).sendKeys("12 Hours");
					//Enter the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2387, 1))).sendKeys(Keys.ENTER);
					
					//Click the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2388, 1))).click();
					//Select the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2389, 1))).sendKeys("Default");
					//Enter the Time Format
					driver.findElement(By.xpath(excel.getData(3, 2389, 1))).sendKeys(Keys.ENTER);
					...
					if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Application Settings updated successfully"))
					{
