...
//						long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
		...
		/*		        //Print number of Rows
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[3]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Tax")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[4]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Discount")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//table[@class='table table-bordered ng-table-responsive table-condensed ng-scope ng-table']/tbody/tr["+rows.size()+"]/td[5]/span")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Grand_Sale")))
				        {
			...
			//	us.captureScreenshot(driver, "Daily Sale");
			//	String screenshotName;
			//	TakesScreenshot ts=(TakesScreenshot)driver;

			//	File source=ts.getScreenshotAs(OutputType.FILE);

			//	test.addBase64ScreenShot("Daily Report");//(LogStatus.INFO, FileUtils.copyFile(source, new File("res/"+screenshotName+".png")));
