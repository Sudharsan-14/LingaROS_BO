...
public class Inventory_Adjust_Inventory_Item {
	...
	ExtentTest test = rep.startTest("Inventory_Adjust_Inventory_Item");
		...
		public void Adjust_Inventory_Openpage(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(5000);
			//Get the URl
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"adjustInventoryItem");
...
/*		Thread.sleep(3000);
		//Clear the Adjust inventory reason type
		driver.findElement(By.xpath(excel.getData(3, 2301, 1))).click();
		//Enter the Adjust inventory reason type
		driver.findElement(By.xpath(excel.getData(3, 2302, 1))).click();
		//Enter the Adjust inventory reason type
		driver.findElement(By.xpath(excel.getData(3, 2302, 1))).sendKeys(Keys.ENTER);
			
		//Thread.sleep(3000);

		Thread.sleep(3000);
		//Clear the Adjust inventory reason type option
		driver.findElement(By.xpath(excel.getData(3, 2301, 1))).click();
		//Enter the Adjust inventory reason type
		driver.findElement(By.xpath(excel.getData(3, 2302, 1))).sendKeys(Utility.getProperty("Increase_Inventory_Reason_name"));
		//Enter the Adjust inventory reason type
		driver.findElement(By.xpath(excel.getData(3, 2302, 1))).sendKeys(Keys.ENTER);*/
