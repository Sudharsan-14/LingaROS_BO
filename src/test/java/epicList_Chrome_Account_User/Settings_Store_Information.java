...
public class Settings_Store_Information {
	...
	/*		Thread.sleep(13000);
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"newEdit");
			Thread.sleep(5000);
			try
			{
		...
		public void Store_Information_editpage(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//select[@name='timeZone']/../div/a")).click();
			Thread.sleep(2000);
			//Enter the required Time Zone 
			driver.findElement(By.xpath("//select[@name='timeZone']/../div/div/div/input")).sendKeys(Utility.getProperty("Settings_Store_Information_TimeZone"));
			//Click the Enter button
			driver.findElement(By.xpath("//select[@name='timeZone']/../div/div/div/input")).sendKeys(Keys.ENTER);
...
/*		  //Clear the Default Languages
		    ...
		    //Default Language
		    driver.findElement(By.xpath("//select[@name='defaultLanguage']/../div/a")).click();
		    //Select Default Language
		    driver.findElement(By.xpath("//select[@name='defaultLanguage']/../div/div/div/input")).sendKeys(Utility.getProperty("Settings_Store_Information_Language"));
			//Enter tbe Default Language
		    driver.findElement(By.xpath("//select[@name='defaultLanguage']/../div/div/div/input")).sendKeys(Keys.ENTER);
	...
	try
	{
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele1)).getText().equalsIgnoreCase("Store updated successfully"))
			{
	...
	{
		test.log(LogStatus.INFO, "Store Information already Exists");
	}
