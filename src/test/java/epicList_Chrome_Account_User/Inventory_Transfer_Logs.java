	...
	ExtentTest test = rep.startTest("Inventory_Transfer_Logs");
		...
		public void Inventory_Transfer_Logs_Pageopen(WebDriver driver) throws Exception
		{
			 ...
			 File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				...
				Thread.sleep(5000);
					...
					//Get the URl
					driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"transfer/transferLogs");
					Thread.sleep(5000);
		...
		public void Inventory_Transfer_Logs_ALL(WebDriver driver) throws Exception
		{
			 File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				...
				driver.findElement(By.xpath(excel.getData(3, 1683, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
						
				//Select the TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1684, 1))).clear();
				//Enter the  required TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1684, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
				...
				else if(driver.findElement(By.xpath(excel.getData(3, 1687, 1))).getText() != null && driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[3]/div/div/div/div[2]/div/table/tbody/tr[2]/td[7]")).getText() != null)
				{
		...
		public void Inventory_Transfer_Logs_InventoryItem(WebDriver driver) throws Exception
		{
			 File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				...
				//Enter the required From Date Range
				driver.findElement(By.xpath(excel.getData(3, 1699, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
						
				//Select the TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1700, 1))).clear();
				//Enter the  required TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1700, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
		...
		public void Inventory_Transfer_Logs_SubRecipe(WebDriver driver) throws Exception
		{
			 File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
				...
				//Enter the required From Date Range
				driver.findElement(By.xpath(excel.getData(3, 1693, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));
						
				//Select the TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1694, 1))).clear();
				//Enter the  required TO Date Range
				driver.findElement(By.xpath(excel.getData(3, 1694, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
