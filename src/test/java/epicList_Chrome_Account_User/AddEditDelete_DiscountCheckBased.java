...
/*		//Click the Products/Items option
		...
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"check_based/discount/list");
	...
	public void Check_Based_Discount_method_addDiscount_CheckBased(WebDriver driver) throws Exception
	{
		...
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount"));
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown']/button")).click();
		Thread.sleep(1000);
		//Click the amount option from the given list
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown open']/ul/li[1]/a")).click();

		Thread.sleep(1000);
		//Clear the amount field
		driver.findElement(By.xpath("//input[@ng-model='offerObj.minAmountStr']")).clear();
		//Enter the amount When it is applicable
		driver.findElement(By.xpath("//input[@ng-model='offerObj.minAmountStr']")).sendKeys("1000000");
		//Clear the amount field
		driver.findElement(By.xpath("//input[@ng-model='offerObj.discountStr']")).clear();
		//Enter how much of amount is discount for the particular product
		driver.findElement(By.xpath("//input[@ng-model='offerObj.discountStr']")).sendKeys("500");
		
		Thread.sleep(60000);
		//Click the Exclude Category field
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul")).click();
		//Enter the Exclude Category field
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul/li/input")).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter key
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		Thread.sleep(3000);
		
		//Click the Exclude Menu Item field
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul")).click();
		//Enter the Exclude Menu Item field
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul/li/input")).sendKeys(Keys.ARROW_DOWN);
		//Press the Enter key
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		Thread.sleep(3000);
		...
		//Check weather the new Discount Check based is updated or not
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"1");
		...
		Thread.sleep(1000);
		//Click the amount option from the given list
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown open']/ul/li[2]/a")).click();
		...
		driver.findElement(By.xpath("//input[@ng-model='offerObj.discountStr']")).clear();
		//Enter how much of amount is discount for the particular product
		driver.findElement(By.xpath("//input[@ng-model='offerObj.discountStr']")).sendKeys("200");
	...
	public void Check_Based_Discount_method_cancelButton(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"2");
		Thread.sleep(5000);
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsAlways_SaveAndPublish(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"20");
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown']/button")).click();
		//Click the amount option from the given list
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown open']/ul/li[3]/a")).click();
		...
		WebElement ele=driver.findElement(By.cssSelector("span > span.ng-scope"));
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsDaysOfMonth(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"21");
		Thread.sleep(5000);
...
/*		//Click the Add symbol
		...
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown']/button")).click();
		//Click the amount option from the given list
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown']/button/../ul/li[1]/a")).click();
*/		
/*		//Click the Exclude Category field
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul")).click();
		//Enter the Exclude Category field
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul/li/input")).sendKeys("PIZZA");
		//Press the Enter key
		driver.findElement(By.xpath("//select[@name='excludeCategories']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul")).click();
		//Enter the Exclude Menu Item field
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul/li/input")).sendKeys("COKE");
		//Press the Enter key
		driver.findElement(By.xpath("//select[@name='excludeMenuItems']/../div/ul/li/input")).sendKeys(Keys.ENTER);
		Thread.sleep(3000);*/
		...
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown']/button")).click();
		//Click the amount option from the given list
		driver.findElement(By.xpath("//div[@class='input-group-btn dropdown open']/ul/li[4]/a")).click();
		...
		driver.findElement(By.xpath("//label[contains(.,'Free Items')]/span[2]/a/i")).click();
		
		//Click the Items Option
		driver.findElement(By.xpath("//select[@ng-model='freeItem.menuItem']/../div[1]/a")).click();
		//Press the Enter button
		driver.findElement(By.xpath("//select[@ng-model='freeItem.menuItem']/../div[1]/div/div/input")).sendKeys(Keys.ENTER);
		
		Thread.sleep(3000);
		//Click the Items Option
		driver.findElement(By.xpath("//select[@ng-model='freeItem.servingSize']/../div/a")).click();
		//Press the Enter button
		driver.findElement(By.xpath("//select[@ng-model='freeItem.servingSize']/../div/div/div/input")).sendKeys(Keys.ENTER);
		...
		driver.findElement(By.xpath("//input[@ng-model='freeItem.quantity']")).clear();
		//Enter the Quantity
		driver.findElement(By.xpath("//input[@ng-model='freeItem.quantity']")).sendKeys("1");
	...
	//	driver.findElement(By.tagName("html")).sendKeys(Keys.ARROW_UP);
		...
		driver.findElement(By.xpath("//label[.='DAYS OF MONTH']/../div/table/tbody/tr[2]/td[7]")).click();
		Thread.sleep(5000);
		...
		WebDriverWait wait = new WebDriverWait(driver, 60);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@role='alert']/span/span")));
...
//		Thread.sleep(7000);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String s1 = driver.findElement(By.xpath("//div[@role='alert']/span/span")).getText();Thread.sleep(3000);
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodasDateRange(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"22");
		Thread.sleep(5000);
...
/*		//Click the Exclude Category field
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsSpecificDate(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"23");
		Thread.sleep(5000);
...
/*		//Click the Exclude Category field
	...
	public void Check_Based_Discount_method_editDiscount_CheckBased_TimePeriodAsStartDateTimeAndEndDateTime(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@name='name']")).clear();
		//Enter the Name
		driver.findElement(By.xpath("//input[@name='name']")).sendKeys(Utility.getProperty("DiscountName_CheckBased_Amount")+"24");
		Thread.sleep(5000);
