...
/*		//Click the Settings option
		...
		Thread.sleep(15000);
		driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"newPrinterReroute");
		Thread.sleep(8000);
		try
		{
...
WebElement ele=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
		...
		WebDriverWait wait=new WebDriverWait(driver,60);
		 ...
		 if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Printer Reroute Saved Successfully"))
		{
...
WebElement ele=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
		...
		WebDriverWait wait=new WebDriverWait(driver,50);
		 ...
		 if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Printer Reroute Updated Successfully"))
		{
...
File src = new File(Utility.getProperty("Excel_Sheet_Path_For_Xpath"));
		...
		WebDriverWait wait=new WebDriverWait(driver,50);
		 ...
		 if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Printer Reroute Deleted Successfully"))
		{
