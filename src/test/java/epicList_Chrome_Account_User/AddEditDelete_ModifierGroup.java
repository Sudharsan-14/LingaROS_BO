...
public class AddEditDelete_ModifierGroup {
	...
	ExtentTest test = rep.startTest("AddEditDelete Modifier Group");
		...
		public void Modifiers_Group_method_openModifier_Groups(WebDriver driver) throws Exception
		{
			...
			driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"modifierGroups");
			Thread.sleep(8000);
		...
		//	Thread.sleep(4000);
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Modifier group saved successfully"))
			{
	...
	WebElement ele=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Modifier group updated successfully"))
			{
	...
	WebElement ele=driver.findElement(By.xpath(excel.getData(3, 39, 1)));
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Modifier group activated successfully"))
			{
