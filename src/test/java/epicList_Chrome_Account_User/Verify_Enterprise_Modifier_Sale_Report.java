...
//					test.log(LogStatus.INFO, "Total Time : "+ActualfinishTimeDouble1);
		...
		/*		        //Print number of Rows
				        ...
				        if(driver.findElement(By.xpath("//div[@id='main-container']/div[2]/div/div/div[2]/div[2]/div/div/div/div/div[6]/table/tbody/tr["+rows.size()+"]/td[4]")).getText().equals(Utility.getReportPropertyUser("Modifier_Sale_Report_Quantity")))
				        {
