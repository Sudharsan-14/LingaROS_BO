	...
	*/		
		...
		/*	List<WebElement> rows = driver.findElements(By.xpath(excel.getData(4, 56, 1)));
			...
			//	driver.findElement(By.xpath("//form[@name='imageform']/div[2]/div/div/div[3]/div[1]/a/img")).click();
				...
				driver.findElement(By.xpath("//select[@name='menu']/../div/div/div/input")).sendKeys(Utility.getProperty("Product_Retail_Items_Child_Name"));
				Thread.sleep(2000);
				//Press the Enter Key
				...
				if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Child item updated successfully"))
				{
	...
	//	driver.findElement(By.xpath(excel.getData(4, 102, 1))).click();
		...
		//	driver.findElement(By.xpath(excel.getData(4, 103, 1))).click();
			...
			if(wait.until(ExpectedConditions.visibilityOf(ele)).getText().equalsIgnoreCase("Retail item updated and published successfully"))
			{
		...
		public void Retail_Item_saveAndContinueRetailItemByCopyRetailItem(WebDriver driver) throws Exception
		{
			...
			Thread.sleep(1000);
			//Check whether the Restriction Time Enabled or not
			if(driver.findElement(By.xpath("//label/span[contains(.,'Restriction Time')]")).isSelected())
			{
