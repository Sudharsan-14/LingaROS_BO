...
public class SendMail_Royalty_Franchise {
	...
	public static void snedMailWithAttachment()
	{
		...
		try {
			...
			message.setSubject("BO Automation Report for Royalty and Franchise"+dte);
 
			// Create object to add multimedia type content
			BodyPart messageBodyPart1 = new MimeBodyPart();
 
			// Set the body of email
			messageBodyPart1.setText("Hi Team, \n PFA of BO Automation Report for Royalty/Franchise \n Thanks Team");
