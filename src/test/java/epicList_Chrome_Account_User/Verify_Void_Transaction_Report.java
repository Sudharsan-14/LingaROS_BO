	...
	float unknownValue = 00;
		...
		public void calling() throws Exception
		{
			...
			public void Void_Transaction_Report_Method_openpage(WebDriver driver) throws Exception
			{
				...
				Thread.sleep(3000);
				//Enter the Users URL
				driver.get(Utility.getProperty("baseURL")+Utility.getProperty("store_Id1")+"report/voidTransactionSale");
...
//					long ActualfinishTimeDouble = ((totalTime%86400)%3600)/60;
	...
	WebElement ele=driver.findElement(By.xpath(excel.getData(3, 1601, 1)));
						...
						if(a == numChecks)
						{
							...
							//Enter the date
							driver.findElement(By.xpath(excel.getData(1, 845, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_From"));

							Thread.sleep(2000);
							//Clear the date field
							driver.findElement(By.xpath(excel.getData(1, 846, 1))).clear();
							//Enter the date
							driver.findElement(By.xpath(excel.getData(1, 846, 1))).sendKeys(Utility.getReportPropertyUser("Date_Range_To"));
