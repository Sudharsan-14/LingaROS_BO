...
//					test.log(LogStatus.INFO, "Total Time : "+ActualfinishTimeDouble1);
		...
		/*	        //Print number of Rows
				        ...
				        if(driver.findElement(By.xpath("//tr["+rows.size()+"]/td[contains(@data-title-text,'Quantity')]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Quantity")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//tr["+rows.size()+"]/td[contains(@data-title-text,'Discount')]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Discount")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//tr["+rows.size()+"]/td[contains(@data-title-text,'% of Sale')]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Percentage_Of_Sale")))
				        {
				        ...
				        if(driver.findElement(By.xpath("//tr["+rows.size()+"]/td[contains(@data-title-text,'Rounding Off')]/span")).getText().equals(Utility.getReportPropertyUser("Sub_Category_Sale_Report_Rounding_Off")))
				        {
