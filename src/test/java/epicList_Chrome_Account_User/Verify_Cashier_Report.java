...
//					test.log(LogStatus.INFO, "Total Time : "+ActualfinishTimeDouble1);
				...
				if(driver.getPageSource().contains("TAXES"))
				{
					...
					if(driver.findElement(By.xpath("//label[contains(.,'TAXES')]/../../div[contains(.,'Rounding Off')]/div[2]")).getText().equals(Utility.getReportPropertyUser("Sale_Report_Rounding_Off")))
					{
						test.log(LogStatus.PASS, "Actual and Expected Rounding Off are same");
						
			        	//Get the Total value of Rounding Off
			        	String actualText1 = driver.findElement(By.xpath("//label[contains(.,'TAXES')]/../../div[contains(.,'Rounding Off')]/div[2]")).getText();
					...
					else if(expect1 == unknownValue)
					{
			        	...
			        	//Get the Total value of Check Count
			        	String actualText = driver.findElement(By.xpath("//label[contains(.,'TAXES')]/../../div[contains(.,'Rounding Off')]/div[2]")).getText();
